...
/*CREATE OR REPLACE FUNCTION as_ts_award_count_fn
(  div_name      as_data.award_of_work%type
...
where asa.ts_date between frmdate and todate
 AND  asa.award_of_work = div_name;
...
CREATE OR REPLACE FUNCTION as_ts_award_sum_fn
(  div_name      as_data.award_of_work%type
 , frmdate        as_data.ts_date%type
 , todate        as_data.ts_date%type
)
RETURNs float AS $v_count$
declare
v_count    float:=0; 
BEGIN
...
CREATE OR REPLACE VIEW as_ts_award_view AS
SELECT  aw.award_of_work
, as_ts_award_count_fn(aw.award_of_work,'2014-04-01 00:00:00+05:30' , '2015-03-31 00:00:00+05:30') as noofworks2014_2015
, as_ts_award_sum_fn(aw.award_of_work,'2014-04-01 00:00:00+05:30' , '2015-03-31 00:00:00+05:30') as totalcost2014_2015

, as_ts_award_count_fn(aw.award_of_work,'2015-04-01 00:00:00+05:30' , '2016-03-31 00:00:00+05:30') as noofworks2015_2016
, as_ts_award_sum_fn(aw.award_of_work,'2015-04-01 00:00:00+05:30' , '2016-03-31 00:00:00+05:30') as totalcost2015_2016

, as_ts_award_count_fn(aw.award_of_work,'2016-04-01 00:00:00+05:30' , '2017-03-31 00:00:00+05:30') as noofworks2016_2017
, as_ts_award_sum_fn(aw.award_of_work,'2016-04-01 00:00:00+05:30' , '2017-03-31 00:00:00+05:30') as totalcost2016_2017

, as_ts_award_count_fn(aw.award_of_work,'2017-04-01 00:00:00+05:30' , '2018-03-31 00:00:00+05:30') as noofworks2017_2018
, as_ts_award_sum_fn(aw.award_of_work,'2017-04-01 00:00:00+05:30' , '2018-03-31 00:00:00+05:30') as totalcost2017_2018

, as_ts_award_count_fn(aw.award_of_work,'2018-04-01 00:00:00+05:30' , '2019-03-31 00:00:00+05:30') as noofworks2018_2019
, as_ts_award_sum_fn(aw.award_of_work,'2018-04-01 00:00:00+05:30' , '2019-03-31 00:00:00+05:30') as totalcost2018_2019


FROM as_data_view aw

 group by  aw.award_of_work
