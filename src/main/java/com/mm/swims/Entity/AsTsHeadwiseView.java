...
/*
CREATE OR REPLACE FUNCTION as_ts_headwise_count_fn
(  div_name      as_data.head_of_account%type
...
where asa.ts_date between frmdate and todate
 AND  asa.head_of_account = div_name;
...
CREATE OR REPLACE FUNCTION as_ts_headwise_sum_fn
(  div_name      as_data.head_of_account%type
 , frmdate        as_data.ts_date%type
 , todate        as_data.ts_date%type
)
...
CREATE OR REPLACE VIEW as_ts_headwise_view AS
SELECT hw.head_of_account
, as_ts_headwise_count_fn(hw.head_of_account,'2014-04-01 00:00:00+05:30' , '2015-03-31 00:00:00+05:30') as noofworks2014_2015
, as_ts_headwise_sum_fn(hw.head_of_account,'2014-04-01 00:00:00+05:30' , '2015-03-31 00:00:00+05:30') as totalcost2014_2015

, as_ts_headwise_count_fn(hw.head_of_account,'2015-04-01 00:00:00+05:30' , '2016-03-31 00:00:00+05:30') as noofworks2015_2016
, as_ts_headwise_sum_fn(hw.head_of_account,'2015-04-01 00:00:00+05:30' , '2016-03-31 00:00:00+05:30') as totalcost2015_2016

, as_ts_headwise_count_fn(hw.head_of_account,'2016-04-01 00:00:00+05:30' , '2017-03-31 00:00:00+05:30') as noofworks2016_2017
, as_ts_headwise_sum_fn(hw.head_of_account,'2016-04-01 00:00:00+05:30' , '2017-03-31 00:00:00+05:30') as totalcost2016_2017

, as_ts_headwise_count_fn(hw.head_of_account,'2017-04-01 00:00:00+05:30' , '2018-03-31 00:00:00+05:30') as noofworks2017_2018
, as_ts_headwise_sum_fn(hw.head_of_account,'2017-04-01 00:00:00+05:30' , '2018-03-31 00:00:00+05:30') as totalcost2017_2018

, as_ts_headwise_count_fn(hw.head_of_account,'2018-04-01 00:00:00+05:30' , '2019-03-31 00:00:00+05:30') as noofworks2018_2019
, as_ts_headwise_sum_fn(hw.head_of_account,'2018-04-01 00:00:00+05:30' , '2019-03-31 00:00:00+05:30') as totalcost2018_2019


FROM as_data_view hw
group by hw.head_of_account
